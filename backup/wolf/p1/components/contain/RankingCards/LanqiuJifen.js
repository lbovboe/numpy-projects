      ...
      <div>
        ...
        >
          <div className="mt-[15px]">
            <div
              className={`grid grid-cols-[24px_2fr_repeat(4,1fr)] min12:grid-cols-[24px_1fr_30px_30px_40px_40px] ${headerStyles}`}
            >
              <p>排名</p>
            ...
            <div className="">
              {data.map((v, i) => (
                <div
                  key={i}
                  className={`grid grid-cols-[24px_2fr_repeat(4,1fr)] min12:grid-cols-[24px_1fr_30px_30px_40px_40px] ${bodyStyles}`}
                >
                  <Rank
                    i={i}
                    rank={v.rank}
                  ...
                  <p>{v.wins}</p>
                  <p>{v.losses}</p>
                  <p>{v?.matches ? ((v.wins / v?.matches) * 100).toFixed(0) : "0"}%</p>
