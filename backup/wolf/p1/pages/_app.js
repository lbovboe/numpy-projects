...
import SideNav from "../components/contain/SideNav";
import SubNavHeader from "../components/header/SubNavHeader";
  ...
  return (
    <>
      ...
      <Header
        ...
        isNavDisplay={pageProps.isNavDisplay}
      ></Header>
      <ScrollButton showAlways={pageProps.showAlways} />
      <div className="w-full max-w-[1200px] mx-auto max12:px-[10px]">
        {!pageProps.isIndexPage ? (
          <div className="flex flex-wrap gap-[20px]">
            <SubNavHeader title={pageProps.navTitle} tags={pageProps.navTags} />
            <div className="min12:max-w-[390px] w-full">
              <SideNav />
            </div>
            <div className="min12:max-w-[790px] w-full">
              <Component
                {...pageProps}
