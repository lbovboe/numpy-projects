    ...
    data && (
      <div>
          <div className="rounded-[10px] overflow-hidden">
            <div
              className={`grid grid-cols-[24px_2fr_repeat(4,1fr)] min12:grid-cols-[24px_1fr_50px_50px_50px_50px] ${headerStyles}`}
            >
              <p>排名</p>
            ...
            <div className="">
              {data.map((v, i) => (
                <div
                  key={i}
                  className={`grid grid-cols-[24px_2fr_repeat(4,1fr)] min12:grid-cols-[24px_1fr_50px_50px_50px_50px] ${bodyStyles}`}
                >
