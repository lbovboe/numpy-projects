    ...
    data && (
      <div>
        <div className="rounded-[10px] border border-solid border-border-color p-[20px]">
          ...
          <hr className="border-border-color mt-[15px]" />
          <div className="mx-auto w-full mt-[20px]">
            <a
              ...
              target="_blank"
            >
              <div className="absolute inset-0 m-auto flex items-center justify-center rounded-[10px] w-[169px] h-[56px] bg-white border border-solid border-border-color group-hover:border-sec-color">
                <svg
                  width={40}
                  height={40}
          ...
          {dataCard?.match && (
            <a
              ...
              className="block mt-[20px] rounded-[10px] border border-solid border-border-color pl-[20px] hover:border-sec-color overflow-hidden"
            >
              {getDetails(dataCard.match)}
            </a>
          )}
        </div>
      </div>
    ...
    <div className="group grid grid-cols-[6fr_1px_4fr] gap-x-[20px] items-center p-[20px] rounded-[10px] border border-solid border-border-color hover:border-sec-color text-[14px] whitespace-nowrap">
      ...
      <div className="flex flex-col gap-y-[5px]">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="underline underline-offset-2 group-hover:text-sec-color">
            視頻觀看
          </p>
        </div>
